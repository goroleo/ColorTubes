...
static const quint32 CT_FILL_MODE        = 100;          // unsupported now. Correct JctlFormat::read() to use this mode
...
static const quint8  CT_TIMER_TICKS      = 7;            // ticks interval in milliseconds
static const quint8  CT_BLINK_TICKS      = 20;           // ticks when blinking
...
static const quint8  CT_SHADE_STEPS_INC  = 28;           // steps to opacity increment when shade layer appears
static const quint8  CT_SHADE_STEPS_DEC  = 20;           // steps to opacity decrement when shade layer disappears
static const quint8  CT_CORK_STEPS_INC   = 12;           // steps to opacity increment when cork layer appears
...
static const quint8  CT_FLOWER_TICKS     = 7;                // ticks fhen flower rotating
static const qreal   CT_FLOWER_ANGLE_INC = 0.8 * CT_DEG2RAD; // flower angle rotation per one tick
